...
const AddRecipe = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto mt-24 bg-[#EFE4D2] p-8 rounded-2xl shadow-xl">
      <h1 className="text-center text-3xl font-bold text-[#4B352A] mb-8">Add New Recipe</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="relative mb-4">
              ...
              <textarea name="description" value={form.description} onChange={handleChange} placeholder="Description" className="w-full pl-10 pr-4 py-2 border rounded focus:ring-2 focus:ring-[#CA7842] h-28 resize-none bg-white" required spellCheck={false} />
            </div>
            <div className="mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                {form.image && <span className="text-sm text-[#4B352A]">{form.image.name}</span>}
              </div>
            </div>
            <div className="relative mb-4">
          ...
          <div>
            <div className="relative mb-4">
              ...
              <textarea name="ingredients" value={form.ingredients} onChange={handleChange} placeholder="Ingredients (one per line)" className="w-full pl-10 pr-4 py-2 border rounded focus:ring-2 focus:ring-[#CA7842] h-28 resize-none bg-white" required spellCheck={false} />
            </div>
            <div className="relative mb-4">
              <FiList className="absolute left-3 top-3 text-[#CA7842]" />
              <textarea name="steps" value={form.steps} onChange={handleChange} placeholder="Steps (one per line)" className="w-full pl-10 pr-4 py-2 border rounded focus:ring-2 focus:ring-[#CA7842] h-28 resize-none bg-white" required spellCheck={false} />
            </div>
            <div className="relative mb-4">
              <FiEdit className="absolute left-3 top-3 text-[#CA7842]" />
